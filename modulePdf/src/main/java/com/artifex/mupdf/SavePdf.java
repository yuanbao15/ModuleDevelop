...
public class SavePdf {
    ...
    public void addText() {
        try {
            ...
            float auto = rectangle.getWidth() / (bitmap.getWidth() / 2); // 放大比例
            float newwidth = bitmap.getWidth() / 2 / scale * auto;
            float newheight = bitmap.getHeight() / 2 / scale * auto;
            img.scaleAbsolute(newwidth, newheight);
            //ok了没有偏移
//            img.scaleAbsolute(352 * 1.0f * density / 2 / scale * rectangle.getWidth() / (bitmap.getWidth() / 2), 550 * 1.0f * density / 2 / scale * rectangle.getWidth() / (bitmap.getWidth() / 2));
