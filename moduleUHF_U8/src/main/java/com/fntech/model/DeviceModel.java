...
public class DeviceModel implements DeviceModelImp {
    ...
    public DeviceModel(Context context) {
        ...
        if (SystemRelease.equals("4.0.3")) {
            ...
            if (mContext.getResources().getDisplayMetrics().heightPixels == SetAndSaveActivity.P01DisplayHeight) {
                names = mContext.getResources().getStringArray(R.array.P01_GPIO);
            } else {
                names = mContext.getResources().getStringArray(R.array.m96_GPIO);
            }
...
//				e.printStackTrace();
    ...
    public Device getDeviceFromModel(String model) {
        ...
        } else if (SystemRelease.equals(SetAndSaveActivity._7_1_2)) {
            if (mContext.getResources().getDisplayMetrics().heightPixels == SetAndSaveActivity.P01DisplayHeight) {
                String[] M96_GPIO = mContext.getResources().getStringArray(R.array.P01_GPIO);
                gpioLength = M96_GPIO.length;

            } else {
                String[] M10A_GPIO = mContext.getResources().getStringArray(R.array.P01SerialPort);
                gpioLength = M10A_GPIO.length;

            }
        } else if (SystemRelease.equals(SetAndSaveActivity._9_0_0)) {
            if (mContext.getResources().getDisplayMetrics().heightPixels == SetAndSaveActivity.P01DisplayHeight) {
                String[] M96_GPIO = mContext.getResources().getStringArray(R.array.P01_GPIO);
                gpioLength = M96_GPIO.length;
